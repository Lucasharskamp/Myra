...
namespace Myra.Samples.CustomUIStylesheet
{
	public partial class AllWidgets : HorizontalSplitPane
	{
		...
		{ 
			...
			var node1 = TreeView.AddSubNode(new Label
			{
				Text = "node1"
			});
			...
			{
				Renderable = CustomUIStylesheetGame.CustomStylesheet.Atlas["plus"]
			});
			...
			{
				Renderable = CustomUIStylesheetGame.CustomStylesheet.Atlas["minus"]
			});
